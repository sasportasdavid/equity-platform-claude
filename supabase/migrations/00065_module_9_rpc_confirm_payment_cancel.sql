-- ============================================================
-- Module 9 B1 — RPCs confirm_exercise_payment + cancel_exercise_request
-- ============================================================
--
-- 1. confirm_exercise_payment : admin (permission `exercises.confirm_payment`)
--    confirme la réception du paiement → exercise.status = COMPLETED + update
--    awards.units_exercised + status PARTIALLY/FULLY_EXERCISED.
--
-- 2. cancel_exercise_request :
--    - Bénéficiaire (cancel.own) : peut cancel uniquement PENDING/APPROVED
--    - Admin (cancel.any) : peut cancel partout sauf COMPLETED/CANCELLED/REJECTED
--    Cancel propage à approval_requests si en cours.

-- ============================================================
-- 1. confirm_exercise_payment
-- ============================================================
