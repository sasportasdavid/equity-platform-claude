...
export const step2Schema = z.object({
  ...
  // Module 6 B5 — opt-in : auto-générer le document d'attribution quand un
  // award sur ce plan passe en APPROVED via le workflow Module 5. Default
  // false (V1) pour éviter le spam de docs sur le backfill admin.
  autoGenerateDocument: z.boolean().optional(),
});
